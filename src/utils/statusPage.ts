// backend/src/utils/statusPage.ts
import { prisma } from '../lib/prisma';

/**
 * Renders an interactive System Health & Diagnostic HTML Dashboard
 * Tests real-time MariaDB pool connection latency and Node.js process health
 */
...
<head>
  ...
  <title>Bamunugama M.V. API • System Status</title>
  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .glow-1 { width: 450px; height: 450px; background: var(--emerald); top: -100px; right: -100px; }
    .glow-2 { width: 400px; height: 400px; background: var(--indigo); bottom: -100px; left: -100px; }
  ...
  <div class="card-container">
    <div class="shadcn-card">
      <div class="header-row">
        <div>
          <div class="brand-title">Bamunugama Navodya Vidyalaya</div>
          <div class="brand-subtitle">Express REST API Core • Contabo VPS</div>
        </div>
      ...
      <div class="status-indicator ${dbStatus ? 'connected' : 'disconnected'}">
        <div>
          <div class="status-indicator-title">MariaDB Driver Adapter (Pool: 5)</div>
          <div class="status-indicator-desc">
            ${dbStatus ? `Live ping successful • Latency: ${dbLatencyMs}ms` : 'Failed to ping MariaDB database'}
          </div>
        </div>
        <div class="badge ${dbStatus ? 'badge-success' : 'badge-danger'}">
      ...
      <div class="metrics-grid">
        ...
        <div class="metric-card">
          <div class="metric-label">Server Mode</div>
          <div class="metric-value">${isLSNode ? 'OpenLiteSpeed Pipe' : 'Standalone Port'}</div>
        </div>
      </div>
